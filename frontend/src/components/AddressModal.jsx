...
const AddressModal = function ({ landmark, address }) {
  ...
  return (
    <div className="cursor-pointer w-max rounded-md flex m-auto bottom-0 left-1/2 -translate-x-1/2 fixed z-[1050] bg-white p-5 gap-5">
      ...
      {!isFormOpen && (
        <div className="flex flex-col justify-around">
          <div className="rounded-md px-2 py-0.5 ring-2 ring-red-600 text-center">
            Enable
          </div>
